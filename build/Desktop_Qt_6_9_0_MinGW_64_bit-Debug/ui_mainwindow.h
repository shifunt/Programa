...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        btnVerNovedades->setObjectName("btnVerNovedades");

        gridLayout->addWidget(btnVerNovedades, 8, 3, 1, 1);

        chkPropietario = new QCheckBox(centralwidget);
        chkPropietario->setObjectName("chkPropietario");
        ...
        btnBorrarNovedad->setObjectName("btnBorrarNovedad");
